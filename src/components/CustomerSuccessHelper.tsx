            ...
            {showMunaTip && (
              <div className="p-3 rounded-xl bg-[#131314] border border-amber-500/30 text-xs text-slate-300 relative flex items-start gap-2.5">
                ...
                <button
                  ...
                  className="absolute top-2 right-2 text-slate-500 hover:text-slate-300 cursor-pointer"
                >
            ...
            <div className="p-3 rounded-xl bg-[#131314] border border-amber-500/30 space-y-2">
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  className="px-2.5 py-1 rounded-lg bg-amber-500/15 hover:bg-amber-500/25 border border-amber-500/30 text-amber-300 font-mono text-[10px] flex items-center gap-1 transition-colors cursor-pointer"
                >
                  {isVerifyingHash ? (
                    <span>Verifying...</span>
                  ) : (
          ...
          {isCompleted ? (
            <div className="text-center py-6 space-y-4 animate-fadeIn">
              ...
              <div className="pt-2 flex justify-center gap-3">
                ...
                <button
                  onClick={handleClose}
                  className="px-5 py-2 rounded-xl text-xs font-bold text-black bg-amber-500 hover:bg-amber-400 transition-colors flex items-center gap-1.5 shadow-md cursor-pointer"
                >
        ...
        {!isCompleted && (
          <div className="p-4 border-t border-slate-800/80 bg-[#131314] flex items-center justify-between">
            <button
              ...
              className={`px-3.5 py-2 rounded-xl text-xs font-semibold flex items-center gap-1 transition-colors cursor-pointer ${
                currentStep === 1
            ...
            <div className="flex items-center space-x-2">
              ...
              <button
                onClick={handleNext}
                className="px-5 py-2 rounded-xl text-xs font-bold text-slate-950 bg-amber-500 hover:bg-amber-400 transition-all duration-150 flex items-center gap-1.5 shadow-md active:scale-95 cursor-pointer"
              >
