...
import { NdaInputs, ParseApiResponse } from '@/types';
import { NdaWizardForm } from '@/components/NdaWizardForm';
...
export default function Home() {
  ...
  useEffect(() => {
    // Notify Farcaster client that Mini App is ready
    try {
      sdk.actions.ready();
    } catch (e) {
  ...
  const handleStructuredSubmit = async (inputs: NdaInputs) => {
    ...
    try {
      ...
      // Direct client fallback for 100% service uptime
